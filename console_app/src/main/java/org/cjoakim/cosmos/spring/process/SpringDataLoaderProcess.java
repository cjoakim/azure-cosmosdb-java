...
/**
 * This AbstractProcess is used to load the EPA Ozone Telemetry data into CosmosDB
...
@NoArgsConstructor
@Slf4j
public class SpringDataLoaderProcess extends AbstractProcess implements AppConstants {
